...
class Albumentations:
    ...
    def __init__(self, size=640):
        ...
        try:
            ...
            self.transform = A.Compose(T, bbox_params=A.BboxParams(format='cmvit', label_fields=['class_labels']))
...
def classify_albumentations(
        ...
        std=IMAGENET_STD,
        auto_aug=False):
    # classification Albumentations (optional, only used if package is installed)
    prefix = colorstr('albumentations: ')
    try:
        import albumentations as A
