...
try:
    ...
    COMET_PROJECT_NAME = config.get_string(os.getenv("COMET_PROJECT_NAME"), "comet.project_name", default="CMViT")
...
COMET_MODEL_NAME = os.getenv("COMET_MODEL_NAME", "CMViT")
...
class CometLogger:
    ...
    def __init__(self, opt, hyp, run_id=None, job_type="Training", **experiment_kwargs) -> None:
        ...
        if run_id is None:
            self.experiment.log_other("Created from", "CMViT")
    ...
    def upload_dataset_artifact(self):
        dataset_name = self.data_dict.get("dataset_name", "dataset")
