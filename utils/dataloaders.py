...
class LoadScreenshots:
    # screenshot dataloader, i.e. `python detect.py --source "screen 0 100 100 512 256"`
...
class LoadImagesAndLabels(Dataset):
    ...
    def __init__(self,
        ...
        try:
            ...
            raise Exception(f'{prefix}Error loading data') from e
...
def create_classification_dataloader(path,
                                     ...
                                     workers=8,
                                     shuffle=True):
    # Returns Dataloader object to be used with Classifier
    with torch_distributed_zero_first(rank):  # init dataset *.cache only once if DDP
