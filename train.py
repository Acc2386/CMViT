...
from models.hybird import Model
...
def parse_opt(known=False):
    ...
    parser.add_argument('--epochs', type=int, default=300, help='total t raining epochs')
    ...
    parser.add_argument('--noautoanchor', action='store_true', help='disable AutoAnFchor')
